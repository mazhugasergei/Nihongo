...
export default () => {
  ...
  return (
    <header>
      <Link href="/">Home</Link>
      <div ref={furiganaToggleButton} onKeyDown={hnadleFuriganaToggle} tabIndex={0} style={{ cursor: "pointer", userSelect: "none" }}><div className="furigana">あ<span>あ</span></div></div>
    </header>
  )
}